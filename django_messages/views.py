...
def compose(request, recipient=None, form_class=ComposeForm,
    ...
    #posts1 = Service.objects.all()
    #posts2 = Event.objects.all()
    #posts = Product.objects.all()
    ...
    return render_to_response('django_messages/compose.html', {'form': form}, context_instance=RequestContext(request))
